...
class TestFullPipeline:
    ...
    def sample_spss_data(self):
        ...
        data = {
            'age': [15, 16, 14, 17, 15],
            'MotherEducation': [1, 2, 4, 5, 3],
            'FatherEducation': [2, 4, 5, 4, 3],
            ...
            'RangeOfUsualAgeOfMenarche': [2, 2, 1, 2, 2],
            'WhatDoYouThinkAboutThePrecessofMensturation': [1, 2, 1, 1, 2],
            'OrganOfBodyResponsibleForMenarche': [2, 3, 3, 3, 3],
            'RangeOfNormalDurationOfMensturalBleeding': [4, 4, 4, 3, 4],
            'AfterHowManyDaysDoYouMensturateEveryMonth': [3, 2, 3, 3, 3],
            'WhichTypeOfAbsorbsentToBeUsedDuringMensturation': [1, 2, 3, 4, 5],
            'HowManyTimePerDayClothandSanitaryPadTOBeChanged': [1, 2, 3, 4, 1],
            'HowTheClothAndSanitaryPadToBeDisposeOF': [1, 2, 1, 2, 1],
            'WhereTheSanitaryPadToBeDispoadOF': [1, 2, 1, 2, 2],
            # Practice questions (Section IV) - 7 questions
            'WhichTypeOfAbsorbentDoYouUseDuringMensturation': [1, 2, 3, 4, 5],
            'UsePaperToDisposeThePadByWrapping': [1, 2, 1, 1, 2],
            'WhereDisposeTheUsedPads': [2, 1, 1, 1, 1],
            'HowManyTimeUsualyChangeTheClothandSanitaryPad': [1, 2, 3, 4, 1],
            'HowManyTimesTakeBathDuringMensturation': [1, 2, 1, 1, 1],
            'CleanYourExternalGenitaliaThroughlyWaterDuringMensturation': [2, 1, 2, 1, 2],
            'AfterThatWashHandsWithSoapAndWater': [1, 1, 1, 1, 1],
        }
